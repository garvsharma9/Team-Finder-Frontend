...
export default function ManageTeams() {
  ...
  const styleSheet = `
    ...
    @media (max-width: 640px) {
      ...
      /* Make the delete team button full width on small screens */
      .teams-header-actions .teams-button-danger {
        width: 100%;
        margin-top: 8px;
        text-align: center;
      }
      ...
      /* Stack the user rows on mobile so buttons fit */
      .teams-user-row {
        flex-direction: column;
        align-items: flex-start;
      }
      ...
      .teams-button-muted,
      .teams-button-danger {
        flex: 1; /* Makes buttons stretch to equal width */
        text-align: center;
        padding: 12px; /* Slightly taller for easier tapping */
      }
    }
  `;
