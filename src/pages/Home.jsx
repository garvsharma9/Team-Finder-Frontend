...
//                     <p className="text-sm font-bold text-slate-800 transition-colors group-hover:text-blue-600 leading-none">
//                       {user.name || user.username}
//                     </p>
//                     <p className="text-[10px] font-bold text-blue-600 uppercase tracking-widest mt-1 opacity-0 -translate-y-1 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
//                       Dashboard
//                     </p>
//                   </div>
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 py-16 sm:py-20 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
          ...
          <motion.div initial="hidden" animate="visible" className="text-center lg:text-left">
            ...
            <motion.div custom={3} variants={fadeUp} className="mt-8 flex flex-col w-full sm:w-auto sm:flex-row items-center gap-4 lg:justify-start justify-center">
              {/* --- DYNAMIC HERO BUTTON --- */}
              {user && token ? (
                <Link to="/search" className="w-full sm:w-auto group flex items-center justify-center gap-2 rounded-2xl bg-white px-7 py-3.5 text-base font-bold text-blue-600 shadow-2xl shadow-black/20 transition-all hover:shadow-3xl hover:-translate-y-1">
                  Find Teammates
                  <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Link>
              ) : (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col w-full sm:w-auto sm:flex-row items-center justify-center gap-4">
                {/* --- DYNAMIC CTA BUTTON --- */}
                {user && token ? (
                  <Link to="/search" className="w-full sm:w-auto group flex items-center justify-center gap-2 rounded-2xl bg-white px-8 py-4 text-base font-bold text-blue-600 shadow-2xl transition-all hover:-translate-y-1">
                    Find Teammates
                    <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                  </Link>
                ) : (
